...
import { LayoutDashboard, AlertTriangle, Search, TrendingUp, ListTodo, Shield, Users, FileText, Contact, Bot, } from "lucide-react";
...
const NAV_ITEMS = [
    ...
    { to: "/trades", label: "Trades", icon: TrendingUp, minRole: "reviewer" },
